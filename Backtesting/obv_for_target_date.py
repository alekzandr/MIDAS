...
def pct_change_past_week(target_date, sell_date, num_days_analyze=5, num_days_since_begin_prev_week=5, num_stocks=10):
    ...
    while i < len(list_files):
        ...
        # Debug: Issues reading data from stock CSV
        #print(stock_name)
    ...
    screened_stocks = screened_stocks[screened_stocks['sma_short'] > screened_stocks['sma_long']]
    final_screened = screened_stocks[screened_stocks['ewa_short'] > screened_stocks['ewa_long']]
    ...
    top_10 = final_screened["stock"].tolist()[0:num_stocks]
    list_files = []
    for stock in top_10:
